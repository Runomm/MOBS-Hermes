...
class $MessagesTable extends Messages
  ...
  static const VerificationMeta _speakerLanguageMeta = const VerificationMeta(
    'speakerLanguage',
  );
  @override
  late final GeneratedColumn<String> speakerLanguage = GeneratedColumn<String>(
    'speaker_language',
    aliasedName,
    false,
    additionalChecks: GeneratedColumn.checkTextLength(
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('speaker_language')) {
      context.handle(
        _speakerLanguageMeta,
        speakerLanguage.isAcceptableOrUnknown(
          data['speaker_language']!,
          _speakerLanguageMeta,
        ),
      );
    } else if (isInserting) {
      context.missing(_speakerLanguageMeta);
    }
  ...
  MessageRow map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return MessageRow(
      ...
      speakerLanguage: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}speaker_language'],
      )!,
...
class MessageRow extends DataClass implements Insertable<MessageRow> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['speaker_language'] = Variable<String>(speakerLanguage);
  ...
  MessagesCompanion toCompanion(bool nullToAbsent) {
    return MessagesCompanion(
      ...
      speakerLanguage: Value(speakerLanguage),
  ...
  factory MessageRow.fromJson(
    ...
    return MessageRow(
      ...
      speakerLanguage: serializer.fromJson<String>(json['speakerLanguage']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'speakerLanguage': serializer.toJson<String>(speakerLanguage),
  ...
  MessageRow copyWith({
    ...
    speakerLanguage: speakerLanguage ?? this.speakerLanguage,
  ...
  MessageRow copyWithCompanion(MessagesCompanion data) {
    return MessageRow(
      ...
      speakerLanguage: data.speakerLanguage.present
          ? data.speakerLanguage.value
  ...
  String toString() {
    return (StringBuffer('MessageRow(')
          ...
          ..write('speakerLanguage: $speakerLanguage, ')
  ...
  bool operator ==(Object other) =>
      ...
      (other is MessageRow &&
          ...
          other.speakerLanguage == this.speakerLanguage &&
...
class MessagesCompanion extends UpdateCompanion<MessageRow> {
  ...
  final Value<String> speakerLanguage;
  ...
  const MessagesCompanion({
    ...
    this.speakerLanguage = const Value.absent(),
  ...
  static Insertable<MessageRow> custom({
    ...
    Expression<String>? speakerLanguage,
    ...
    return RawValuesInsertable({
      ...
      if (speakerLanguage != null) 'speaker_language': speakerLanguage,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (speakerLanguage.present) {
      map['speaker_language'] = Variable<String>(speakerLanguage.value);
    }
...
class $$MessagesTableFilterComposer
  ...
  ColumnFilters<String> get speakerLanguage => $composableBuilder(
    column: $table.speakerLanguage,
    builder: (column) => ColumnFilters(column),
  );
...
class $$MessagesTableOrderingComposer
  ...
  ColumnOrderings<String> get speakerLanguage => $composableBuilder(
    column: $table.speakerLanguage,
    builder: (column) => ColumnOrderings(column),
  );
...
class $$MessagesTableAnnotationComposer
  ...
  GeneratedColumn<String> get speakerLanguage => $composableBuilder(
    column: $table.speakerLanguage,
    builder: (column) => column,
  );
        ...
        TableManagerState(
          ...
          updateCompanionCallback:
              ({
                ...
                Value<String> speakerLanguage = const Value.absent(),
